...
As discussed in the [Motivation episode]({{ page.root }}{% link _episodes/06-motivation.md %}),
...
> as discussed [yesterday]({{ page.root }}/{% link _episodes/05-feedback.md %}#minute-cards).
{: .challenge}
